const menu = [
  ...
  },
  {
    ...
    descriptionEn: 'buffalo burrata from Brandenburg, rocket and cherry tomatoes',
  },
  {
    ...
    descriptionEn: 'buffalo mozzarella from Brandenburg, rocket and cherry tomatoes',
  },
  // SALADS
  {
  ...
  },
  {
    ...
    price: '14,00',
    category: 'pizza',
    descriptionDe: 'mit Tomatensoße Gustarosso, Fior di Latte, Thunfisch, Zwiebeln und Oregano',
    descriptionEn: 'with tomato sauce Gustarosso, Fior di Latte, tuna, onions and oregano',
  },
  {
    ...
    price: '14,50',
    category: 'pizza',
    descriptionDe: 'mit Tomatensoße Gustarosso, Büffelburrata aus Brandenburg und Basilikum',
    descriptionEn: 'with tomato sauce Gustarosso, buffalo burrata from Brandenburg and basil',
  },
  {
  ...
  },
  {
    ...
    price: '16,00',
    category: 'pizza',
    descriptionDe: 'mit Creme Fraiche, Räucherlachs, Avocado, Hirtenkäse und rosa Pfeffer',
    descriptionEn: 'with creme fraiche, smoked salmon, avocado, herder cheese and pink pepper',
  },
  // PASTA
  {
    url: '',
  ...
  },
  {
    ...
    price: '16,00',
    category: 'pasta',
    descriptionDe: 'Bandnudeln mit Rose-Soße, Lachsfilet, Dill, Petersilie und Datteltomaten',
    descriptionEn: 'ribbon noodles with rose sauce, salmon fillet, dill, parsley and date tomatoes',
  },
  {
    url: '',
    ...
    descriptionEn: 'ribbon noodles with porcini mushrooms, truffle cream and truffle oil',
  },
  // DESSERT
  {
